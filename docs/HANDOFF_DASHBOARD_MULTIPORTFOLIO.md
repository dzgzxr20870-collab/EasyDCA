...
# ⚠️ ปลดบล็อกแล้ว — แต่มีเงื่อนไข อ่านให้จบก่อน Apply

> **สถานะ (27 ส.ค. 2569): บั๊ก Asset Resolution แก้เสร็จแล้วในโค้ด — ปลดบล็อกได้**
> แต่ **"เสร็จ" ในที่นี้แปลว่า "Container ที่รันอยู่จริงต้องเป็นโค้ดที่แก้แล้ว"**
> ไม่ใช่ "มี Commit อยู่ใน repo"
>
...
ขั้น 7   Verify บน Production **ตามสคริปต์ § 8.1 ซ้ำอีกรอบ + Query (ค)** (หลัง 044)
