...
> ⚠️ **ฝั่ง LINE ยัง Reject อย่างเดียว ยังไม่มีปุ่มเลือกพอร์ต** — เส้นทาง LINE
> ไม่มีคอนเซ็ปต์พอร์ตเลย การทำปุ่มเลือกพอร์ตเป็นงานรอบหน้า (Reuse Pattern
> Quick Reply/Postback ชุดเดียวกับ `buildBrokerPickerMessage` ซึ่ง
> `details.candidates` พก `portfolioId` มาให้พร้อมแล้ว) · ข้อความปัจจุบันบอก
> ผู้ใช้ให้ไปบันทึกผ่านเว็บแทน
