-- ═══════════════════════════════════════════════════════════════════════
-- ⛔⛔⛔  ห้าม Apply ไฟล์นี้ตอนนี้เด็ดขาด — อ่านให้จบก่อน  ⛔⛔⛔
-- ═══════════════════════════════════════════════════════════════════════
-- สถานะ: **บล็อกอยู่** (พบตอนรีวิวโค้ด 24 ส.ค. 2569)
--
...
--
-- แต่โค้ดที่รันอยู่บน Production ตอนนี้ค้นหาสินทรัพย์ด้วย
...
--   2) ⛔ หยุด — แก้บั๊ก Asset Resolution ให้เสร็จ
--   3) Merge + Deploy โค้ดที่แก้แล้ว (ทั้ง EasyDCA และ easydca-worker)
--   4) ยืนยันบน Production ว่า ซื้อ/ขาย/ดูกำไร/LINE ปกติ (ก่อน 044)
--   5) จดเลขแถว + สร้าง _backup_044_assets_portfolio
--   6) Apply 044 → 045
--   7) ยืนยันบน Production อีกรอบ (หลัง 044)
--   8) Apply 046 → 047 → 048
--
