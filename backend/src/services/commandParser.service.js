...
//
// ⚠️ มี 2 ชุดคำโดยตั้งใจ ห้ามลบชุดใดออก แม้จะดูซ้ำซ้อน (fix/undo-command-aliases):
//   - "ยกเลิกล่าสุด"/"ยกเลิกรายการล่าสุด" — คำเดิมตั้งแต่ PRD.md จำนวนหนึ่ง
//     ผู้ใช้พิมพ์คุ้นอยู่แล้ว ลบออกจะทำของที่เคยใช้ได้พังทันที (Backward Compat)
//   - "ย้อนล่าสุด"/"ย้อนรายการล่าสุด" — เพิ่มหลัง fix/misleading-messages (Merge
//     d89c2b6) ที่เปลี่ยนคำที่ "ระบบพูด" ทุกจุด (การ์ด LINE/ปุ่มเว็บ/ป้ายในประวัติ)
//     จาก "ยกเลิกรายการ" เป็น "ย้อนรายการ" เพราะสื่อความจริงกว่า (รายการนี้บันทึก
//     ลง Ledger ไปแล้วจริง ไม่ใช่ถูกยกเลิก) — ถ้าไม่เพิ่มคำนี้ ผู้ใช้จะเห็นการ์ด
//     เขียนว่า "↩️ ย้อนรายการล่าสุดแล้ว" แล้วพิมพ์ "ย้อนล่าสุด" ตามคำที่ระบบสอน
//     เอง แล้วระบบไม่รู้จัก (Founder เป็นคนตั้งข้อสังเกตนี้)
const UNDO_LAST = /^(?:ยกเลิกล่าสุด|ยกเลิกรายการล่าสุด|ย้อนล่าสุด|ย้อนรายการล่าสุด|undo)$/;
