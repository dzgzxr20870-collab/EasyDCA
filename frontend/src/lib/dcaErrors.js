...
// ⚠️ ใช้คำว่า "ย้อน" ไม่ใช่ "ยกเลิก" ตลอดตารางนี้ — คำสั่ง "ยกเลิกล่าสุด" ทำงานกับ
// รายการที่บันทึกลง Ledger ไปแล้วจริง (สร้าง Reversal หักล้าง ไม่ใช่ลบ) คนละสถานะกับ
// Pending ที่ยังไม่เคยบันทึก (transactionErrorMessage ด้านบนใช้ "ยกเลิก" ถูกแล้ว
// สำหรับกรณีนั้น) — มติ Founder: ห้ามใช้คำเดียวกันสองความหมาย ผู้ใช้จะแยกไม่ออกว่า
// ข้อมูลตัวเองอยู่สถานะไหน
const UNDO_ERROR_MESSAGES = {
  ...
  CANNOT_UNDO_QUANTITY_MISMATCH:
    'ย้อนรายการนี้ไม่ได้ เพราะมีการขายเกิดขึ้นหลังจากนั้นแล้ว ทำให้ยอดคงเหลือไม่พอย้อนกลับ',
  UNAUTHORIZED: 'เซสชันหมดอายุ กรุณาเข้าสู่ระบบใหม่อีกครั้ง',
  INTERNAL_ERROR: 'เกิดข้อผิดพลาดภายในระบบ กรุณาลองใหม่อีกครั้ง',
};
